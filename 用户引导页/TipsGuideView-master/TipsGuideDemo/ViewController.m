...
- (void)guide{
    ...
    [guide showInView:window maskBtns:@[self.button1,self.button2,self.button3,self.button4,self.button5,self.self.rightLabel] withTips:@[@"点击此处进行搜索",@"点击此处进行编辑",@"举报用户",@"点击此处进行用于注册",@"123"]];
